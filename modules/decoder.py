...
class RNNDecoderBase(nn.Module):
    ...
    Args:
       ...
       attn_type (str) : see :obj:`GlobalAttention`
       coverage_attn (str): see :obj:`GlobalAttention`
    ...
    def __init__(self, rnn_type, bidirectional_encoder, num_layers,
                 ...
                 coverage_attn=False, copy_attn=False, dropout=0.0,
    ...
    def init_state(self, encoder_final, with_cache=False):
